  ...
  <Head>
    ...
    <main>
      ...
      <section>
        ...
        <p>Welcome to the website of the Boston Open Data Collaborative for Diversity Equity and Inclusion (BODC-DEI). You're the best! We are a group of tech enthusiasts, data analysts, UX designers, quality assurance professionals, and Linux systems administrators who are passionate about using open data to create tools that serve the public in a fair and responsible way.</p>
